...
```bash
mkdir -p ~/.github/skills/{crate_name}
mkdir -p ~/.github/skills/{crate_name}/references
```

### Step 4: Generate SKILL.md

Create `~/.github/skills/{crate_name}/SKILL.md` with this template:
...
agent-browser get text ".docblock" > ~/.github/skills/{crate_name}/references/{module}.md
agent-browser close
```
...
ls -la ~/.github/skills/{crate_name}/
cat ~/.github/skills/{crate_name}/SKILL.md
```
...
4. Create: ~/.github/skills/tokio/SKILL.md
5. Create: ~/.github/skills/tokio/references/
...
All generated skills are saved to: `~/.github/skills/`
...
| Permission denied | Directory issue | Check ~/.github/skills/ permissions |
